...
export const mockProcurementRecords: ProcurementRecord[] = [
  { id:'PR-001', employeeId:'yotam-keret',  employeeName:'Yotam Keret',  poNumber:'PO-4571', supplier:'Elektra Components GmbH', amountUsd:12400, category:'PO Created',      status:'PO Arrived',   notes:'Emergency R&D components — sourced under 24h',      date:'2026-06-11' },
  { id:'PR-002', employeeId:'dan-cohen',     employeeName:'Dan Cohen',     poNumber:'PO-4572', supplier:'Pacific Parts Direct',    amountUsd: 8200, category:'PO Created',       status:'PO Arrived',   notes:'BAZ spare parts replenishment',                     date:'2026-06-10' },
  { id:'PR-003', employeeId:'amit-levy',     employeeName:'Amit Levy',     poNumber:'PO-4573', supplier:'GlobalTech Supply',       amountUsd:34000, category:'PO Created',       status:'PO Issued', notes:'System 120 assembly components — awaiting sign-off', date:'2026-06-10' },
  { id:'PR-004', employeeId:'noa-shaked',    employeeName:'Noa Shaked',    poNumber:'PO-4574', supplier:'Meridian Electronics',    amountUsd:56000, category:'PO Created',       status:'PO Arrived',   notes:'Defence project materials Q2',                      date:'2026-06-09' },
  { id:'PR-005', employeeId:'yotam-keret',  employeeName:'Yotam Keret',  poNumber:'PO-4575', supplier:'Core Components Ltd',     amountUsd: 9600, category:'PO Created',       status:'PO Arrived',   notes:'Inventory replenishment — screens batch',            date:'2026-06-08' },
  { id:'PR-006', employeeId:'yotam-keret',  employeeName:'Yotam Keret',  poNumber:'',        supplier:'Elektra Components GmbH', amountUsd:84000, category:'Supplier Payment', status:'PO Arrived',   notes:'Q2 framework settlement',                           date:'2026-06-11' },
  { id:'PR-007', employeeId:'amit-levy',     employeeName:'Amit Levy',     poNumber:'',        supplier:'Meridian Electronics',    amountUsd:56000, category:'Supplier Payment', status:'PO Arrived',  notes:'Defence project invoice cleared',                   date:'2026-06-09' },
  { id:'PR-008', employeeId:'dan-cohen',     employeeName:'Dan Cohen',     poNumber:'',        supplier:'Pacific Parts Direct',    amountUsd:12400, category:'Supplier Payment', status:'PO Arrived',  notes:'Emergency parts — same-day payment released',       date:'2026-06-10' },
  { id:'PR-009', employeeId:'amit-levy',     employeeName:'Amit Levy',     poNumber:'PO-4571', supplier:'Elektra Components GmbH', amountUsd:12400, category:'Emergency Request',status:'PO Arrived',   notes:'R&D sprint blocker — component sourced in 4h',     date:'2026-06-11' },
  { id:'PR-010', employeeId:'noa-shaked',    employeeName:'Noa Shaked',    poNumber:'PO-4574', supplier:'Meridian Electronics',    amountUsd:56000, category:'Emergency Request',status:'PO Arrived',   notes:'Defence shipment — last-minute approval obtained',  date:'2026-06-09' },
  { id:'PR-011', employeeId:'yotam-keret',  employeeName:'Yotam Keret',  poNumber:'PO-4577', supplier:'Precision Parts Co',     amountUsd: 7100, category:'Emergency Request',status:'PO Issued', notes:'Product support materials — awaiting delivery',     date:'2026-06-08' },
];
