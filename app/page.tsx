...
function Executive() {
  return <>
    ...
    <div className="card">
      <h2 className="section-title">Weekly Executive Highlights</h2>
      <div className="grid two">
...
function AddWeeklyActivity() {
  ...
  return <>
    <section className="hero">
      ...
      <p>Use this form to capture completed work, achievements and operational impact. Executive dashboards show team impact only — not individual rankings or personal performance.</p>
    </section>
    ...
    <div className="card">
      <h2 className="section-title">How this supports the dashboard</h2>
      <p className="small">Weekly submissions are grouped by category and department. Executive dashboards show the Operations team impact only — not individual rankings or personal performance.</p>
    </div>
  </>;
}
